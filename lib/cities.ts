...
export const cities: City[] = [
    ...
    itinerary: [
      {
        ...
        title: "Old City Walk",
        description:
          "Explore the historic heart of the city and discover key architectural landmarks.",
      },
      {
        time: "10:10 — 11:00",
        title: "Mausoleum Visit",
        description:
          "Visit a famous mausoleum and learn about its cultural heritage.",
      },
      {
        time: "11:10 — 12:00",
        title: "Craft Bazaar",
        description:
          "Stroll through local markets and enjoy traditional flavors.",
      },
      {
        time: "12:10 — 13:00",
        title: "Lunch Break",
  ...
  },
  {
    ...
    durationText: "4 days / 3 nights",
    priceFromText: "206,000 UZS",
    galleryImages: ["/sec1.png", "/sec1.png", "/sec1.png", "/sec1.png"],
    description:
    ...
    itinerary: [
      ...
      },
      {
        ...
        description:
          "Visit the resting place of Amir Temur and admire its golden interior.",
      },
      {
        time: "11:10 — 12:00",
  ...
  },
  {
    ...
    aboutActivity: [
      ...
      {
        title: "Host or greeter",
        text: "English, Russian, and Uzbek-speaking hosts",
        iconSrc: "/icon/svg2.svg",
      },
      {
        title: "Duration: 3 day / 2 nights",
        text: "Check availability to see starting times",
        iconSrc: "/icon/svg3.svg",
      },
    ],
    itinerary: [
      {
        ...
        description: "Visit key historical areas and local landmarks.",
      },
      {
        time: "11:00 — 12:30",
        title: "Markets & Crafts",
        description: "Discover traditional crafts and local tastes.",
      },
      {
        time: "12:40 — 13:40",
        title: "Lunch Break",
        description: "Local cuisine in a relaxed setting.",
      },
    ],
    mapEmbedSrc:
